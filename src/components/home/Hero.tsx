        ...
        <div className="bg-white dark:bg-transparent min-h-screen flex items-center">
            <div className="max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
                <div className="text-center">
                    <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl lg:text-6xl dark:text-[#f0b90b]">
                        Nền tảng giao dịch tiền điện tử thế hệ mới
                    </h1>
                    <p className="mt-6 max-w-2xl mx-auto text-xl text-gray-600 dark:text-[#cacaca]">
                    ...
                    <div className="mt-8 flex justify-center gap-x-4">
                        ...
                        <Link href="/markets" className="inline-block bg-white text-black font-bold py-3 px-8 rounded-lg hover:bg-gray-100 transition duration-300">
                            Xem thị trường
                        </Link>
                    </div>
                    <p className="mt-8 text-sm text-gray-500 dark:text-[#cacaca]">
