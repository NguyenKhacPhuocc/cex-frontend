...
export default function DownloadApp() {
    ...
    return (
        <div ref={ref} className="bg-white dark:bg-transparent min-h-screen flex items-center">
                ...
                <div className="grid md:grid-cols-2 gap-10 items-center">
                    ...
                    >
                        ...
                        <div className="mt-8 flex flex-col sm:flex-row gap-4">
                            <Link href="#" className="flex items-center justify-center gap-x-3 bg-gray-900 text-white font-bold py-3 px-6 rounded-lg hover:bg-gray-700 transition duration-300 dark:bg-white/90 dark:text-black/80 dark:hover:bg-white">
                        ...
                        <div className="mt-8 text-white">
                            <p className="text-gray-600 dark:text-white/90">Hoặc quét mã QR để tải:</p>
