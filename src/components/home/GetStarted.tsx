                        ...
                        <div className="grid md:grid-cols-3 gap-10">
                            {steps.map((step, index) => (
                                <div key={step.name} className="relative text-center">
                                    <div className="flex items-center justify-center w-16 h-16 mx-auto bg-[#f0b90b] rounded-full text-2xl font-bold text-black dark:text-white">
                                        {index + 1}
                                    </div>
                                    <div className="mt-5">
                                        <h3 className="text-lg leading-6 font-medium text-gray-900 dark:text-white/90">
                                            {step.name}
                                        </h3>
